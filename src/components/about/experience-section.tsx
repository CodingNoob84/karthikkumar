"use client";
import { experience } from "@/data/contact-info";
import { Award, Briefcase, Building, Clock, MapPinIcon } from "lucide-react";
            ...
            >
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                  ...
                  <motion.div
                    className="flex items-center gap-2 text-slate-500 dark:text-slate-400 mt-2 lg:mt-0"
